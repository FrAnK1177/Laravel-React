            ...
            <div className="flex-1" >
                <div className="flex justify-between items-center" >
                    <div>
                        ...
                        <small className="m1-2 text-sm text-gray-600" > {dayjs(post.created_at).fromNow()} </small>
                        ...
                        {   post.user.id === auth.user.id && 
                                <Dropdown>
                                    ...
                                    <Dropdown.Content>
                                        <button className="block w-full px-4 py-2 text-left text-sm leading-5 text-gray-700 hover:bg-gray-200 focus:bg-gray-100 transition duration-150 ease-in-out" onClick={ ()=> setEditing(true)}>
                                            Edit
                                        </button>
                                        <Dropdown.Link
                                            as="button"
                    ...
                    { editing ?
                        <form onSubmit={submit}>
                            ...
                            <div className="space-x-2" >
                                ...
                                <button className="inline-flex items-center px-2 py-2 border border-solid border-1 border-gray-300 rounded-md font-semibold text-xs uppercase tracking-widest active:bg-gray-300 transition ease-in-out duration-150" onClick={()=>setEditing(false) && reset()} >
                                    Cancel
                                </button>
